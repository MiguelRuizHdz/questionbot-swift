...
func responseTo(question: String) -> String {
    ...
    if question.hasPrefix("hola") {
        ...
        return "¡Al norte!"
    } else if question.hasPrefix("who") || question.hasPrefix("quién") {
        return "¡Al norte!"
    } else if question.hasPrefix("what") || question.hasPrefix("qué") {
        return "¡Al norte!"
    } else if question.hasPrefix("why") || question.hasPrefix("por qué") {
        return "¡Al norte!"
    } else if question.hasPrefix("how") || question.hasPrefix("cómo") {
        return "¡Al norte!"
    } else {
        return "Eso depende"
    }
...
responseTo(question: "¿Where are you?")
responseTo(question: "¿cuál es la capital de Francia?")
responseTo(question: "¿cuál es la capital de Francia?")
responseTo(question: "¿cuál es la capital de Francia?")
